...
import com.oneandahalf.backend.trade.domain.TradeSuggestionValidator;
...
public class TradeSuggestionService {
    ...
    private final TradeSuggestionValidator tradeSuggestionValidator;
    ...
    public Long suggest(SuggestTradeCommand command) {
        ...
        tradeSuggestion.suggest(tradeSuggestionValidator);
